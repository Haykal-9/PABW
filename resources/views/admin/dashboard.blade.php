            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col me-2">
                        ...
                        <div class="h5 mb-0 fw-bold text-gray-800">Rp {{ number_format($data['pendapatanHariIni'], 0, ',', '.') }}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2 border-3 border-info">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col me-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Pendapatan Penjualan</div>
                        <div class="h5 mb-0 fw-bold text-gray-800">Rp {{ number_format($data['totalPendapatan'], 0, ',', '.') }}</div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    <div class="col-12">
        <div class="alert alert-info shadow" role="alert">
            <i class="fas fa-info-circle me-2"></i> Data di atas adalah data dummy statis dari <code>AdminController.php</code>.
        </div>
    </div>
</div>
